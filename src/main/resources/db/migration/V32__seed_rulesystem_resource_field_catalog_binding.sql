...
-- Required rule_entity_type base codes (for example EMPLOYEE_PRESENCE_COMPANY, WORK_CENTER,
...
values
    ('employee.presence', 'companyCode', 'EMPLOYEE_PRESENCE_COMPANY', 'DIRECT', null, null, true),
