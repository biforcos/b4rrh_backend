-- =========================================================
-- V66__seed_payroll_object_binding_for_agreement_99002405011982.sql
-- Bind agreement 99002405011982 to its base salary table SB_99002405011982
-- =========================================================
...
where not exists (
    ...
    where rule_system_code = 'ESP'
      ...
      and binding_role_code = 'BASE_SALARY_TABLE'
);
