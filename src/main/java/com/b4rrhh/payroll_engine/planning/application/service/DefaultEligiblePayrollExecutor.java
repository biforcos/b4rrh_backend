...
public class DefaultEligiblePayrollExecutor implements ExecuteEligiblePayrollUseCase {
    ...
    public EligiblePayrollExecutionResult execute(EligiblePayrollExecutionRequest request) {
        ...
        for (CalculationSegment segment : segments) {
            ...
            segmentResults.add(toSegmentExecutionResult(
                    request.getRuleSystemCode(),
                    segment,
                    daysInPeriod,
                    workingTimePercentage,
        ...
        PocTotals totals = consolidateTotals(segmentResults, AMOUNT_SCALE, ROUNDING);
    ...
    private static BigDecimal resolveWorkingTimePercentage(LocalDate date, List<WorkingTimeWindow> windows) {
    ...
    private static SegmentExecutionResult toSegmentExecutionResult(
    ...
    private static PocTotals consolidateTotals(
