...
public class DeleteContactService implements DeleteContactUseCase {
    ...
    public void delete(DeleteContactCommand command) {
        ...
        String normalizedContactTypeCode = normalizeContactTypeCode(command.contactTypeCode());
        ...
        Contact existing = contactRepository
                .findByEmployeeIdAndContactTypeCode(employee.employeeId(), normalizedContactTypeCode)
        ...
        contactRepository.deleteByEmployeeIdAndContactTypeCode(existing.getEmployeeId(), existing.getContactTypeCode());
    }
