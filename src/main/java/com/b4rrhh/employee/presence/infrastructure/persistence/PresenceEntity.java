...
@Entity
@Table(name = "presence", schema = "employee")
public class PresenceEntity {
    ...
    @Column(name = "entry_reason_code", nullable = false, length = 30)
    ...
    public void setEntryReasonCode(String entryReasonCode) { this.entryReasonCode = entryReasonCode; }

    public String getExitReasonCode() { return exitReasonCode; }
    public void setExitReasonCode(String exitReasonCode) { this.exitReasonCode = exitReasonCode; }
