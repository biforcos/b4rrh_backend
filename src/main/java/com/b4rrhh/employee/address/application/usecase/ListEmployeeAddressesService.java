...
@Service
public class ListEmployeeAddressesService implements ListEmployeeAddressesUseCase {

    private final AddressRepository addressRepository;
    private final EmployeeAddressLookupPort employeeAddressLookupPort;

    public ListEmployeeAddressesService(
    ...
    @Override
    public List<Address> listByEmployeeBusinessKey(
        ...
        return addressRepository.findByEmployeeIdOrderByStartDate(employee.employeeId());
    }
