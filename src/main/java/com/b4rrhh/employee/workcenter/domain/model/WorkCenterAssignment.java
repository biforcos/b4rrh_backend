...
public class WorkCenterAssignment {
    ...
    public WorkCenterAssignment close(LocalDate closeDate) {
        if (!isActive()) {
    ...
    public WorkCenterAssignment correct(String newWorkCenterCode, LocalDate newStartDate, LocalDate newEndDate) {
        return new WorkCenterAssignment(
                id,
                employeeId,
                workCenterAssignmentNumber,
