...
@Service
public class UpdateCostCenterService implements UpdateCostCenterUseCase {
    ...
    public UpdateCostCenterService(
    ...
    @Override
    @Transactional
    public CostCenterAllocation update(UpdateCostCenterCommand command) {
        ...
        CostCenterAllocation updated = existing.updateAllocationPercentage(command.allocationPercentage());
